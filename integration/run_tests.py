...
tests_not_compared = [
    ...
    "mainnet/trace_call/test_02.json_", # diff on callType
    "mainnet/trace_call/test_03.json", # diff on callType
    "mainnet/trace_call/test_05.json_", # diff on callType
    "mainnet/trace_call/test_06.json_", # diff on callType
    ...
    "mainnet/trace_call/test_13.json_", # diff on callType
    ...
    "mainnet/trace_call/test_18.json_", # diff on callType
